...
partidas = np.random.exponential(1 / mu1, 100000)  # vetor de partidas MM1
#partidas = 0.2*np.ones(100000)  # vetor de partidas MD1
...
print("Número médio de elementos no sistema: " + str(eq) + '.')
