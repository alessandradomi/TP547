...
lambda1 = 0.6  # taxa media de chegada
mu1 = 1  # taxa media de serviço
...
while (t < 10000):  # tempo limite de simulacao
...
print("O tempo médio no sistema é: " + str(np.mean(ts)) + ' min.')
print("O número médio de pacotes na fila é: " + str(ew) + '.')
